...
//
  ...
  #define X2_SERIAL_TX_PIN                  PD4
  #define X2_SERIAL_RX_PIN                  PD4
  ...
  #define E0_SERIAL_TX_PIN                  PG11
  #define E0_SERIAL_RX_PIN                  PG11

  #define E1_SERIAL_TX_PIN                  PG13
  #define E1_SERIAL_RX_PIN                  PG13
